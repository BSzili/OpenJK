...
#define qglDrawElements(a, b, c, in) glDrawElements(a, b, c, (GLvoid *)in)

#undef qglTexSubImage2D
#define qglTexSubImage2D(a, b, c, d, e, f, g, h, data) glTexSubImage2D(a, b, c, d, e, f, g, h, (GLvoid *)data)
#undef qglTexImage2D
#define qglTexImage2D(a, b, c, d, e, f, g, h, data) glTexImage2D(a, b, c, d, e, f, g, h, (GLvoid *)data)

static void stub_glArrayElement(GLint i) { glArrayElement(i); }
#undef qglArrayElement
#define qglArrayElement stub_glArrayElement
#endif

#if defined(__MORPHOS__) || defined(__amigaos4__)
#undef qglFogfv
#define qglFogfv(a, color) glFogfv(a, (GLfloat *)color)
#endif
